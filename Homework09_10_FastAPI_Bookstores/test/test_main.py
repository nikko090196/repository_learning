...
def test_get_all_api():
    ...
    response_put_data, response_put_data_1, response_get_data_2 = json.loads(
        response_put.text), json.loads(response_put_1.text), json.loads(response_get_2.text)
    assert response_get_data_2 == [response_put_data, response_put_data_1]
